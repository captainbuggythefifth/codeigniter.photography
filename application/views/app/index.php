<div class="content-container">
    ...
    <div class="memories-container container-fluid" id="memories">
    ...
    <div class="services-container container-fluid" id="services">
        <div class="col-md-12" style="margin-top: 50px; text-align: center">
        ...
        <div class="col-md-6 col-md-offset-5">
            ...
            <img src="/assets/images/h_vector40.png" style="width: 250px;"/>
        </div>
    </div>
            ...
            <div class="col-md-6 col-md-offset-3" style="background-color: white; margin-top: 50px">
                ...
                <form class="form-horizontal" style="margin-top: 50px">
                    <div class="col-sm-10 col-md-offset-1">
                        ...
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-raised btn-lg btn-block">submit</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="testimonial-container" id="testimonies">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-md-offset-5">

                    <div class="tilted testimonial-red col-sm-12 col-md-6 testimonial-background">
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-1">
                    ...
                    <div class="tilted testimonial-blue col-sm-12 col-md-6 testimonial-background">
    ...
    <div class="footer-container">
        <div class="container">
            <div class="social-media-container col-sm-12 col-md-6">
